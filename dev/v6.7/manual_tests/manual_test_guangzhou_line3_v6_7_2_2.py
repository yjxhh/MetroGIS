...
def test_guangzhou_line3_v6_7_2_2():
    ...
    print("\n" + "=" * 96)
    print("MetroGIS V6.7-2.2 广州 3 号线 Route Master Station Completion 实战测试")
    print("=" * 96)
    print(f"BBox = {BBOX}")
    print("=" * 96)
    ...
    print(f"completion added       = {completion.get('total_added_stops')}")
    ...
    # at Haichong Lu. V6.7-2.2 should recover both terminals from same-cohort
    ...
    print("✅ V6.7-2.2 Route Master Station Completion 生效")
    print("=" * 96)
